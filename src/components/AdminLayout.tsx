          ...
          <div>
            ...
            <div className="relative">
              <input
                ...
                className={`w-full px-3 py-2 border rounded focus:ring-2 outline-none pr-9 transition ${
                  emailError
              ...
              {emailTouched && email.length > 0 && (
                <span className="absolute right-2.5 top-1/2 -translate-y-1/2 text-base select-none pointer-events-none">
                  {emailValid ? '✅' : '❌'}
                </span>
              )}
            </div>
            {emailError && (
              <p className="mt-1 text-xs text-red-600 underline decoration-red-400">
                Wrong email address
              </p>
            )}
          </div>
          ...
          <div>
            ...
            <div className="relative">
              <input
                ...
                onKeyDown={(e) => e.key === 'Enter' && doLogin()}
                className={`w-full px-3 py-2 border rounded focus:ring-2 outline-none pr-16 transition ${
                  passwordError
                    ? 'border-red-500 focus:ring-red-300 bg-red-50'
              ...
              <div className="absolute right-2.5 top-1/2 -translate-y-1/2 flex items-center gap-1.5">
                ...
                {passwordTouched && password.length > 0 && (
                  <span className="text-base select-none pointer-events-none">
                    {passwordValid ? '✅' : '❌'}
                  </span>
                )}
                {/* Toggle eye */}
                <button
                  ...
                  className="text-gray-400 hover:text-gray-600 transition text-base leading-none select-none"
                  tabIndex={-1}
                >
                  {showPassword ? '🙈' : '👁️'}
                </button>
